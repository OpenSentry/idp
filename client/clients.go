...
type UpdateClientsResponse Client
...
func UpdateClients(client *IdpClient, url string, requests []UpdateClientsRequest) (status int, responses bulky.Responses, err error) {
