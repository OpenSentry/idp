...
Confirm two-factor code of an Identity. Requires scope `authenticate:identity`. If the verification code matches what was generated by the [POST /identities/2fa](#post-identities-2fa) endpoint. The Identity is authenticated.
